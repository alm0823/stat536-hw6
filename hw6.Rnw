...
<<prob6a>>=
resid.var <- summary(lm.Year)$sigma^2

rand.noise <- rnorm(10000,0,resid.var)
@
...
$\sigma^2_{0.03}$ = $\frac{\Sexpr{resid.var}}{1-0.03}  = \frac{\Sexpr{resid.var}{0.97} = 0.0012$

$\sigma^2_{0.06}$ = $\frac{\Sexpr{resid.var}}{1-0.06}  = \frac{\Sexpr{resid.var}}{0.94} = 0.0011$
