...
\hline
OLS $t$-test & \Sexpr{formatC(lm.noise_type1, digits = 4, format = "fg")} \\
OLS permutation test & \Sexpr{formatC(lm.perm_type1, digits = 4, format = "fg")} \\
Sen CI & \Sexpr{formatC(mblm.noise_type1, digits = 4, drop0trailing = FALSE)}
